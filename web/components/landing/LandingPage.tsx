          ...
          <div className="lg:col-span-6 flex justify-center lg:justify-end">
            <Reveal delay={0.1} y={32}>
              <div className="relative">
                ...
                <Owl
                  size={600}
                  className="relative drop-shadow-xl w-[380px] sm:w-[460px] lg:w-[600px] h-auto max-w-full -translate-y-5"
                />
              </div>
            </Reveal>
          </div>
...
function ProblemSolution() {
  return (
    <section className="py-24 md:py-32 border-y border-stone-200/70 bg-white/50">
...
function Features() {
  ...
  return (
    <section id="features" className="py-20 md:py-24 bg-gradient-to-b from-transparent to-amber-50/40">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          <Reveal>
